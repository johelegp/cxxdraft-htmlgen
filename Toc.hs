...
tocHeader date commitUrl =
	...
	++ " by <a href='https://github.com/johelegp/cxxdraft-htmlgen/tree/jegp'>cxxdraft-htmlgen</a>.)"
...
writeTocFile sfs Draft{..} = do
	...
	let
	    descMeta = "<meta name='description' content='Browser-friendly rendering of the JEGP library'>"
	...
	writeFile (outputDir ++ "/index.html") $ applySectionFileStyle sfs $ LazyText.toStrict $ TextBuilder.toLazyText $
		fileContent "" "JEGP Library: Contents" (descMeta ++ tocStyle) $
			"<h1 style='text-align:center; hyphens:none'>JEGP Library</h1>" ++
